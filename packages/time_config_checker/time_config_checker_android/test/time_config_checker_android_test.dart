...
void main() {
  final TimeConfigCheckerAndroidPlatform initialPlatform = TimeConfigCheckerAndroidPlatform.instance;

  test('$MethodChannelTimeConfigCheckerAndroid is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelTimeConfigCheckerAndroid>());
  });

  test('getPlatformVersion', () async {
    TimeConfigCheckerAndroid timeConfigCheckerAndroidPlugin = TimeConfigCheckerAndroid();
    MockTimeConfigCheckerAndroidPlatform fakePlatform = MockTimeConfigCheckerAndroidPlatform();
    TimeConfigCheckerAndroidPlatform.instance = fakePlatform;

    expect(await timeConfigCheckerAndroidPlugin.getPlatformVersion(), '42');
  });
}
